## <p style="text-align: center;">ОТЧЕТ</p> <p style="text-align: center;">по домашним заданиям к занятию «Работа с roles»</p>
...
```
>по факту выполнения
![localImage](./screen_III.04.01.png) 
![localImage](./screen_III.04.02.png) 
